...
<section id="hero">
  ...
  <h1 style="color:#ffff00; text-align:center; font-size:40px; margin-top:20%;"> News & Eventi</h1>
   <h2 style="color:#ffd700; text-align:center; font-size:30px; margin-bottom:5%;">Parco San Lazzaro</h2>
	...
	<?php
		...
		//$conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
			...
			$sql = 'SELECT numero_id, titolo_notizia, testo_notizia FROM notizie'; //scrivo query
			...
			{
				echo '
				<h3 style="color:#ff0000; font-size:25px;">'.$row['titolo_notizia'].'</h3> 
            <p style="color:#ffffff; font-size:15px;"> <b>'.$row['testo_notizia'].' </b></p> <br>
				';
			}
